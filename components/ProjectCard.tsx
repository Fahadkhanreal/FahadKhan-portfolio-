...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden h-full flex flex-col shadow-lg hover:shadow-2xl hover:shadow-[#64ffda]/10 transition-shadow ${
